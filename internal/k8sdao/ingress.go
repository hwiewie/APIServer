...
// parseEndpoint 將 endpoint 信息解析成對應的 networkingv1.Ingress 信息
...
// getV1IngreeRule 返回對應的 networking Ingress Rule 信息
// host: www.baidu.com
// path: /v0/api/*
...
// getIngressTLS 返回對應的 networking Ingress TLS 信息
// host: wwww.baidu.com
// sercret: secretName
...
// parsePath 解析並返回 具體Path 及 Path類型
// pathWithType: /v0/api*
