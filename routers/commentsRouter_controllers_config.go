...
func init() {
	const BaseConfigController = "github.com/hwiewie/APIServer/controllers/config:BaseConfigController"
	...
	const ConfigController = "github.com/hwiewie/APIServer/controllers/config:ConfigController"
