...
func init() {
	const KubeCRDController = "github.com/hwiewie/APIServer/controllers/kubernetes/crd:KubeCRDController"
	...
	const KubeCustomCRDController = "github.com/hwiewie/APIServer/controllers/kubernetes/crd:KubeCustomCRDController"
