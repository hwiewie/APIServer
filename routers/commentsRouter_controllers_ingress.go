...
func init() {
	const IngressController = "github.com/hwiewie/APIServer/controllers/ingress:IngressController"
	...
	const IngressTplController = "github.com/hwiewie/APIServer/controllers/ingress:IngressTplController"
