...
func init() {
	const DeploymentController = "github.com/hwiewie/APIServer/controllers/deployment:DeploymentController"
	...
	const DeploymentTplController = "github.com/hwiewie/APIServer/controllers/deployment:DeploymentTplController"
