...
func init() {
	const DaemonSetController = "github.com/hwiewie/APIServer/controllers/daemonset:DaemonSetController"
	...
	const DaemonSetTplController = "github.com/hwiewie/APIServer/controllers/daemonset:DaemonSetTplController"
