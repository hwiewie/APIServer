...
func (c *LoggedInController) publishRequestMessage(code int, data interface{}) {
	...
	// 由於框架及項目抽象設計的問題，`data`作為interface類型多次傳遞，從Success/Error函數中傳入的`data`可能的類型有：
	//   * string
	//   * nil
	//   * 實現MarshalJSON的任意結構
	var body []byte
