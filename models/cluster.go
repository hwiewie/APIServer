	...
	/*
		   {
			  ...
			  "rbd": {              // rbd默認配置，創建或修改RBD類型的PV時會使用此配置填充
			    "monitors": [
			      "10.10.10.1:6789",
			      "10.10.10.2:6789",
			      "10.10.10.3:6789"
			  ...
			  "cephfs": {         // cephfs默認配置，創建或修改cephfs類型的PV時會使用此配置填充
			    "monitors": [
			      "10.10.10.4:6789",
			      "10.10.10.5:6789",
			      "10.10.10.6:6789"
...
type ClusterMetaData struct {
	...
	// rbd默認配置，創建或修改RBD類型的PV時會使用此配置填充
	RBD *v1.RBDVolumeSource `json:"rbd"`
	// cephfs默認配置，創建或修改cephfs類型的PV時會使用此配置填充
	CephFS *v1.CephFSVolumeSource `json:"cephfs"`
	// 默認添加環境變量，會在發布資源時在每個Container添加此環境變量, will be overwrite by namespace's Env
	Env []v1.EnvVar
	...
	// 默認添加service註解，會在發布資源時在每個service添加此Annotations, will be overwrite by namespace's Annotations
	ServiceAnnotations map[string]string `json:"serviceAnnotations,omitempty"`
	// 默認添加ingress註解，會在發布資源時在每個ingress添加此Annotations, will be overwrite by namespace's Annotations
